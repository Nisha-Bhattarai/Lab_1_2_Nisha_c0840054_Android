...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    TextView saveMapTV, cancelMapTV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveMapTV = findViewById(R.id.saveMapTV);
        cancelMapTV = findViewById(R.id.cancelMapTV);

        saveMapTV.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        cancelMapTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(MapsActivity.this);
